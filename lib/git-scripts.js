 ...
 * @param {Array} arguments for the hook
 * @param {Function} callback
 * @api public
 */

GitScripts.prototype.run = function(name, args, callback) {
  ...
  this.script(name, function(err, cmd) {
    if (err) return callback(err);
...
GitScripts.prototype.script = function(name, callback) {
